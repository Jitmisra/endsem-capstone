      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-2xl">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Join EduStore to access NCERT books and notes
          </p>
        </div>
          ...
          <div className="rounded-xl shadow-sm space-y-4">
            ...
            <div>
              ...
              <select
                id="role"
                name="role"
                className="appearance-none relative block w-full px-4 py-3 border-2 border-gray-300 text-gray-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 focus:z-10 sm:text-sm transition-all"
                value={role}
